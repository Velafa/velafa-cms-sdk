...
Use this package from a Next.js (or any Node 18+) website to resolve published pages, load data feeds, and proxy published `sitemap.xml` / `llms.txt` / `llms-full.txt` / `robots.txt` artifacts.
